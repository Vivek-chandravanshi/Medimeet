...
const Myprofile = () => {
  ...
  return userData && (
    <div className='max-w-lg flex gap-2 flex-col text-sm'>
      {
        isEdit 
        ? <label htmlFor='image'>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          <p className='text-blue-500'>Email id : </p>
      ...
      <div>
        ...
        <div className='gid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
      ...
      <div className='mt-10'>
          {
            isEdit 
            ? <button className='border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transition-all' onClick={updateUserProfileData}>Save Informatoin</button>
